export const universalEmailRecoveryModuleAbi = [
  {
    type: "constructor",
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      { name: "account", type: "address", internalType: "address" },
      { name: "recoveryData", type: "bytes", internalType: "bytes" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
    ...
    inputs: [{ name: "templateIdx", type: "uint256", internalType: "uint256" }],
    outputs: [{ name: "", type: "uint256", internalType: "uint256" }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "accountSalt", type: "bytes32", internalType: "bytes32" },
    ],
    outputs: [{ name: "", type: "address", internalType: "address" }],
    stateMutability: "view",
  },
  ...
  { type: "error", name: "AccountNotConfigured", inputs: [] },
  { type: "error", name: "AddressAlreadyGuardian", inputs: [] },
  { type: "error", name: "AddressNotGuardianForAccount", inputs: [] },
  {
    type: "error",
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "executeAfter", type: "uint256", internalType: "uint256" },
    ],
  },
  {
    type: "error",
    ...
    inputs: [
      ...
      { name: "weightCount", type: "uint256", internalType: "uint256" },
    ],
  },
  { type: "error", name: "InvalidAccountAddress", inputs: [] },
  { type: "error", name: "InvalidCommandHandler", inputs: [] },
  { type: "error", name: "InvalidDkimRegistry", inputs: [] },
  { type: "error", name: "InvalidEmailAuthImpl", inputs: [] },
  {
    type: "error",
  ...
  { type: "error", name: "InvalidGuardianWeight", inputs: [] },
  { type: "error", name: "InvalidOnInstallData", inputs: [] },
  {
    type: "error",
  ...
  { type: "error", name: "MaxNumberOfGuardiansReached", inputs: [] },
  { type: "error", name: "MaxValidatorsReached", inputs: [] },
  { type: "error", name: "NoRecoveryConfigured", inputs: [] },
  { type: "error", name: "NoRecoveryInProcess", inputs: [] },
  {
    type: "error",
  ...
  { type: "error", name: "RecoveryInProcess", inputs: [] },
  { type: "error", name: "RecoveryIsNotActivated", inputs: [] },
  { type: "error", name: "RecoveryModuleNotInitialized", inputs: [] },
  {
    type: "error",
  ...
  { type: "error", name: "SetupAlreadyCalled", inputs: [] },
  { type: "error", name: "SetupNotCalled", inputs: [] },
  {
    type: "error",
  ...
  { type: "error", name: "TooManyValuesToRemove", inputs: [] },
] as const;
