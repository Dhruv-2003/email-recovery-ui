const kernelV3_1ImplementationAbi = [
  {
    inputs: [
      {
  ...
  {
    inputs: [
      { internalType: "ValidationId", name: "_rootValidator", type: "bytes21" },
  ...
  {
    inputs: [
      { internalType: "contract IExecutor", name: "executor", type: "address" },
    ],
    name: "executorConfig",
    outputs: [
      {
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: "PassFlag", name: "permissionFlag", type: "bytes2" },
          { internalType: "contract ISigner", name: "signer", type: "address" },
          {
...
export default kernelV3_1ImplementationAbi;
